...
(function (b) {
    ...
    b.prototype = {
        ...
        init: function (e, d) {
            ...
            c.fn.editableContainer.defaults, d);
            this.splitOptions();
            ...
            if (!c(document).data("editable-handlers-attached")) {
                c(document).on("keyup.editable",
                function (f) {
                    if (f.which === 27) {
                        c(".editable-open").editableContainer("hide")
                    }
                });
                c(document).on("click.editable",
                function (j) {
                    var f = c(j.target),
                    g,
    ...
    var a = function (d, c) {
        this.$element = b(d);
        this.options = b.extend({},
        b.fn.editable.defaults, c, b.fn.editableutils.getConfigData(this.$element));
    ...
    a.defaults = b.extend({},
    b.fn.editabletypes.list.defaults, {
    ...
    a.defaults = b.extend({},
    b.fn.editabletypes.text.defaults, {
    ...
    var a = function (d, c) {
        ...
        this.options = b.extend({},
        b.fn.combodate.defaults, c, this.$element.data());
        this.init()
    };
    a.prototype = {
        constructor: a,
        ...
        fillDay: function () {
            ...
            e,
            f,
            c = this.options.template.indexOf("DD") !== -1;
            for (f = 1; f <= 31; f++) {
        ...
        fillMonth: function () {
            ...
            e,
            f,
            h = this.options.template.indexOf("MMMM") !== -1,
        ...
        fillYear: function () {
            ...
            d,
            e,
            f = this.options.template.indexOf("YYYY") !== -1;
        ...
        fillHour: function () {
            ...
            f,
            h,
            k = this.options.template.indexOf("h") !== -1,
        ...
        fillSecond: function () {
            ...
            e,
            f,
            c = this.options.template.indexOf("ss") !== -1;
    ...
    h.prototype = {
        ...
        _process_options: function (n) {
            ...
            r.daysOfWeekDisabled = g.map(r.daysOfWeekDisabled,
            function (o) {
    ...
    function f(q, t) {
        ...
        n = {},
        r,
        p = new RegExp("^" + t.toLowerCase() + "([A-Z])"),
    ...
    g(document).on("focus.datepicker.data-api click.datepicker.data-api", '[data-provide="datepicker"]',
    function (o) {
        var n = g(this);
    ...
    b.extend(a.prototype, {
        initPicker: function (c, d) {
            ...
            this.options.datepicker = b.extend({},
            d.datepicker, c.datepicker, {
